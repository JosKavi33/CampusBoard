...
export class proyecto_usuarioDTO {
    constructor(id_proyecto_usuario, id_proyecto, id_usuario, id) {
...
__decorate([
    ...
    Transform(({ value }) => { if (/^[0-9]+$/.test(value) || value == undefined)
        ...
        throw { status: 400, message: `El dato poyecto_usuario incumple los parametros acordados` }; }, { toClassOnly: true }),
    __metadata("design:type", Number)
], proyecto_usuarioDTO.prototype, "ID", void 0);
__decorate([
    ...
    __metadata("design:type", Number)
], proyecto_usuarioDTO.prototype, "proyecto", void 0);
__decorate([
    ...
    __metadata("design:type", Number)
], proyecto_usuarioDTO.prototype, "usuario", void 0);
__decorate([
    Expose({ name: 'id' }),
    IsNumber(),
    Transform(({ value }) => { if (/^[0-9]+$/.test(value) || value == undefined)
    ...
    __metadata("design:type", Number)
], proyecto_usuarioDTO.prototype, "ID2", void 0);
