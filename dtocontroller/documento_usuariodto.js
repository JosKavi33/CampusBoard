...
export class documento_usuarioDTO {
    constructor(id_documento_usuario, id_documento, id_usuario, id) {
...
__decorate([
    ...
    Transform(({ value }) => { if (/^[0-9]+$/.test(value) || value == undefined)
        ...
        throw { status: 400, message: `El dato documento_usuario incumple los parametros acordados` }; }, { toClassOnly: true }),
    __metadata("design:type", Number)
], documento_usuarioDTO.prototype, "ID", void 0);
__decorate([
    ...
    __metadata("design:type", Number)
], documento_usuarioDTO.prototype, "documento", void 0);
__decorate([
    ...
    __metadata("design:type", Number)
], documento_usuarioDTO.prototype, "usuario", void 0);
__decorate([
    Expose({ name: 'id' }),
    IsNumber(),
    Transform(({ value }) => { if (/^[0-9]+$/.test(value) || value == undefined)
    ...
    __metadata("design:type", Number)
], documento_usuarioDTO.prototype, "ID2", void 0);
